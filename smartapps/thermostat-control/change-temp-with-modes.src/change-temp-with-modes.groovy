...
preferences {
    ...
    section("Thermostat Mode Setting..."){
    	input "deviceMode", "enum", metadata:[values:["auto","heat", "cool", "off", "do not change"]], defaultValue: "auto", title: "Thermostat Mode?", required: true
    }
    section("Fan Mode Setting..."){
    	input "fanMode", "enum", metadata:[values:["auto", "on", "circulate", "do not change"]], defaultValue: "auto", title: "Fan Mode?", required: true
    }
}
...
def changedLocationMode(evt)
{
    ...
    thermostat.setThermostatMode(deviceMode) // "do not change" just fails out because not a valid Mode option
...
def appTouch(evt)
{
	...
	thermostat.setHeatingSetpoint(heatingSetpoint)
	thermostat.setCoolingSetpoint(coolingSetpoint)
    thermostat.setThermostatMode(deviceMode)
	thermostat.setThermostatFanMode(fanMode)
}
