...
preferences {
	...
	section ("Check these contact sensors") {
		input "sensors", "capability.contactSensor", title: "Which Contact Sensors?", multiple: true
	}
...
def checkSensors()
{
	...
	for (window in sensors) {
		...
		if (window.currentContact == "open") 
        {
        	...
        	log.debug "Found an open door! $devLabel"
